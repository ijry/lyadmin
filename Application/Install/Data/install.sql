...
INSERT INTO `ly_admin_config` (`id`, `title`, `name`, `value`, `group`, `type`, `options`, `tip`, `is_dev`, `is_system`, `create_time`, `update_time`, `sort`, `status`) VALUES
  ...
  (2, '网站标题', 'WEB_SITE_TITLE', '零云', 1, 'text', '', '网站标题前台显示标题', 0, 1, 1378898976, 1379235274, 2, 1),
  (3, '网站口号', 'WEB_SITE_SLOGAN', '领先的积木式云平台', 1, 'text', '', '网站口号、宣传标语、一句话介绍', 0, 1, 1434081649, 1434081649, 3, 1),
  ...
  (6, '网站描述', 'WEB_SITE_DESCRIPTION', '零云是一套基于统一核心的通用互联网+信息化服务解决方案，追求简单、高效、卓越。可轻松实现支持多终端的WEB产品快速搭建、部署、上线。系统功能采用模块化、组件化、插件化等开放化低耦合设计，应用商城拥有丰富的功能模块、插件、主题，便于用户灵活扩展和二次开发。', 1, 'textarea', '', '网站搜索引擎描述', 0, 1, 1378898976, 1379235841, 6, 1),
  ...
  (36, '静态文件独立域名', 'STATIC_DOMAIN', '', 7, 'text', '', '静态文件独立域名一般用于在用户无感知的情况下平和的将网站图片自动存储到腾讯万象优图、又拍云等第三方服务。', 1, 1, 1438564784, 1438564784, 8, 1),
...
) ENGINE=InnoDB AUTO_INCREMENT=1001 DEFAULT CHARSET=utf8mb4_general_ci COMMENT='用户账号表';
