...
class Image
{
    ...
    /**
    * 合成图片信息 复制一张图片的矩形区域到另外一张图片的矩形区域
    ...
    * @return bool
    */
    public function image_copy_image($bg_image,$sub_image,$add_x,$add_y,$add_w,$add_h,$out_image){
        $this->img->image_copy_image($bg_image,$sub_image,$add_x,$add_y,$add_w,$add_h,$out_image);
        return $this;
    }
}
