...
class OrderModel extends Model
{
     ...
     * @author jry <598821125@qq.com>
     */
    protected $tableName = 'site_order';
    ...
    protected $_validate = array(
        ...
        array('site_id', 'require', '站点ID不能为空', self::MUST_VALIDATE, 'regex', self::MODEL_BOTH),
        array('theme_id', 'require', '模板ID不能为空', self::MUST_VALIDATE, 'regex', self::MODEL_BOTH),
    );
